...
set -euo pipefail
# =========================================================================
#  DCFNet-R18 (DSS short connections + CFM multiplicative fusion)
#  Same as DSS but concat→CFM for stronger cross-scale interaction
#  SGD lr=1e-3, no schedule, epochs=100
# =========================================================================
