...
assign {
    ms_tlbp_found    ,  //170:170
    ms_tlbp_index    ,  //169:166
    ms_inst_tlbp     ,  //165:165
    ms_inst_tlbwi    ,  //164:164
    ms_inst_tlbr     ,  //163:163
...
assign ms_to_ws_bus = {
    ...
    ms_tlbp_index   ,  //130:127
    ms_inst_tlbp    ,  //126:126
    ms_inst_tlbwi   ,  //125:125
    ms_inst_tlbr    ,  //124:124
    ms_excode       ,  //123:119
    ms_badvaddr     ,  //118:87  
    ms_cp0_addr     ,  //86:79
    ms_ex           ,  //78:78
...
assign ms_to_ws_valid = ms_valid && ms_ready_go && !ws_eret && !ws_ex && !ws_tlb_flush;
...
always @ (posedge clk) begin
    ...
    end else if (ws_allowin || ws_eret || ws_ex || ws_tlb_flush) begin
        ms_data_buff_valid  <= 1'b0;
        ms_data_buff        <= 32'h0;
    end
end
