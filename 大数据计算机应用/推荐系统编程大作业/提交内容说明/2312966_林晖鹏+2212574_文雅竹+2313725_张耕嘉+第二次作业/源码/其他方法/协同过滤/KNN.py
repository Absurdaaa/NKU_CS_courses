...
class KNNRecommender:
    ...
    def _compute_similarity(self, matrix):
        ...
        elif self.similarity == 'pearson_baseline':
            # 计算基于基线预测的皮尔逊相关系数
            for i in range(n_rows):
                if i % 50 == 0:
...
if __name__ == "__main__":
    ...
    if do_optimize:
        ...
        similarity = 'pearson'  # 'cosine' or 'pearson'
        k = 11
...
'''
训练KNN模型 (方法: item, 相似度: pearson, k: 11)...
计算相似度矩阵...
训练完成，耗时: 746.64秒
在测试集上评估模型...
测试集评估完成，耗时: 2.11秒
...
method        similarity   k       rmse         mse
item  pearson_baseline  11  20.231387  409.309024
