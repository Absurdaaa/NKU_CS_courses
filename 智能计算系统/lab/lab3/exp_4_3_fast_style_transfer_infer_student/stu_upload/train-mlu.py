...
class VGG19(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(*list(a.children())[:4])
        #TODO: 定义self.layer2为第4层卷积后对应的特征
        self.layer2 = nn.Sequential(*list(a.children())[4:9])
        #TODO: 定义self.layer3为第8层卷积后对应的特征
        self.layer3 = nn.Sequential(*list(a.children())[9:18])
        #TODO: 定义self.layer4为第12层卷积后对应的特征
        self.layer4 = nn.Sequential(*list(a.children())[18:27])
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            if i % 10 == 0:
                ...
                save_image(torch.cat((mlu_image_c, mlu_image_g), 3), f'out/train_mlu/{i}.jpg')
        j += 1
